...
class BlockConfig(models.Model):
    ...
    attempts = fields.Integer(string='Attempts Allowed', default=5, required=True)
    block_time = fields.Float(string='Block Time', default=5/60, required=True)
    interval = fields.Float(string='Interval', default=1/60, required=True)
